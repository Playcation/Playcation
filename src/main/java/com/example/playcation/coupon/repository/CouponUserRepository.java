...
public interface CouponUserRepository extends JpaRepository<CouponUser, Long> {
   ...
   */
  @Query("SELECT c.id FROM CouponUser c WHERE c.expiredDate < :expiredDate ")
  Page<Long> findAllIdsByExpiredDateIsBefore(@Param(value = "expiredDate") LocalDate date, Pageable pageable);
}
